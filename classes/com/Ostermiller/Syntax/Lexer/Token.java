 ...
 * Copyright (C) 1999, 2000  Stephen Ostermiller <Syntax@Ostermiller.com>
 * 
...
public abstract class Token{
	 ...
	 * stylesheets to define classes with the same name as 
	 * the desription and write the token in the html file
	...
	/**
	 * Is this token a comment?  Sometimes comments should be
	...
	/**
	 * Is this token whitespace?  Sometimes whitespace should be
	 * ignored (compiling code) other times they should be used
	...
	/**
	 * Is this token an error?  Lets face it, not all code 
