 ...
 * Copyright (C) 2002 Stephen Ostermiller <syntax@ostermiller.com>
 *
...
NameText=([^\=\:\t\f\r\n\\ ]|{Escape})
NameTextWOSeparators=([^\t\f\r\n\\ ]|{Escape})
ValueText=([^\t\f\r\n\\ ]|([\t\f ]*([^\t\f\r\n\\ ]|{Escape}))|{Escape})
Comment=([\!\#][^\r\n]*)
Name=({NameText}*)
Value=((({NameText}+)({ValueText}*{NameTextWOSeparators}+)?)?)
FullValue=((({NameTextWOSeparators}+)({ValueText}*{NameTextWOSeparators}+)?)?)
