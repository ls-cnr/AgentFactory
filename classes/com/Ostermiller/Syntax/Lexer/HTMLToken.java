 ...
 * similarly, the number of characters into the inut at which it ended. <br>
 */ 
public class HTMLToken extends Token {

  public final static int START_TAG = 0x100;
  public final static int END_TAG = 0x101;
  public final static int DOCTYPE_TAG = 0X102;
   ...
   */
  public HTMLToken(int ID, String contents, int lineNumber, int charBegin, int charEnd, int state){
	this.ID = ID;
