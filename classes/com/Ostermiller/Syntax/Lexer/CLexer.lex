...
AnyChrChr=([^\'\n\r\\])
TrigraphChar = ({HASH}|{LBRACKET}|{RBRACKET}|{CARET}|{LBRACE}|{RBRACE}|{VERTICAL}|{TILDA})
...
<YYINITIAL, MIDDLE_OF_LINE> {TILDA} {
    nextState = MIDDLE_OF_LINE;
...
<YYINITIAL, MIDDLE_OF_LINE> {VERTICAL} {
    nextState = MIDDLE_OF_LINE;
...
<YYINITIAL, MIDDLE_OF_LINE> {CARET} {
    nextState = MIDDLE_OF_LINE;
