 ...
 * @author  Luca
 */
public class component_wizard_com_sheet1 implements command {
    ...
    public component_wizard_com_sheet1(WizardDialogCOM dialog,multi_agent_system project,Vector agenti_esterni) {
    ...
    public void execute() {
        ...
        wizard_panel.setNext( new component_wizard_com_sheet2(wizard_dialog,current_model,lista_agenti_esterni)  );
