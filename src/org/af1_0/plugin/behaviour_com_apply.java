 ...
 * @author  Luca
 */
public class behaviour_com_apply implements command {
    ...
    public behaviour_com_apply(WizardDialogCOM dialog, multi_agent_system project, pattern a_pattern) {
    ...
    public void execute() {
        ...
        String task_name = wizard_panel.getSelectionPanel().getEntityName();
