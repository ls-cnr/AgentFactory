 ...
 * @author  Luca
 */
public class behaviour_wizard_sheet1 implements command {
    ...
    public behaviour_wizard_sheet1(controls_panel the_controls, multi_agent_system current, TreeModelUpdate model) {
    ...
    public void execute() {
        ...
        controls.getWizardPanel().setNext( new behaviour_wizard_sheet2( controls, current_model, tree_model) );
