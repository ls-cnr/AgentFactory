 ...
 * @author  Luca
 */
public class component_wizard implements command {
    ...
    public component_wizard(controls_panel the_controls, multi_agent_system current, TreeModelUpdate model) {
    ...
    public void execute() {
        controls.getWizardPanel().getPatternListPanel().setTitle("Component pattern list");
        controls.getWizardPanel().getPatternOverviewPanel().setTitle("Component pattern overview");
        controls.getWizardPanel().getSelectionPanel().setTitle("Agent target selection");
        ...
        controls.getWizardPanel().getSelectionPanel().setEntityList(agent_list);
        
        // 3.0 mostra la prima scheda
        component_wizard_sheet1 sheet1 = new component_wizard_sheet1( controls, current_model, tree_model);
